...
def main() -> int:
    ...
    variants = [
        ...
        Variant(name="ctx5_short_best", side_mode="short_only", session_mode="all", require_ctx5_align=True, require_ctx5_rf_not_opposite=True, min_reset_bars=2, max_reset_bars=18, min_neutral_bars=1, require_counter_weak=False, max_bars_since_regime=120, deep_touch_min_atr=-0.60, deep_touch_max_atr=0.25, max_entry_gap_atr=1.30, require_mfi_rebound=False, be_arm_r=0.80, be_mfi_long=65.0, be_mfi_short=35.0, take_profit_r=2.0, max_hold_bars=240),
    ]
